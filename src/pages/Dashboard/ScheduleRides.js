...
const ScheduleRides = () => {
    ...
    // Fetch rides data from the API when the component mounts
    useEffect(() => {
        axios.get('http://localhost:8085/trips')
            ...
            .catch(error => {
                console.error('Error fetching rides:', error); // Log any errors that occur
            });
    }, []);
    ...
    // Further filter to only include pending rides
        ...
        <AdminApp>
            <div className="container py-4 mb-5 mt-4">
                ...
                <div className="d-flex justify-content-between mb-3">
                    ...
                    {/* Search input for filtering the rides */}
                ...
                <div className="table-responsive">
                    <table className="table table-striped">
                        ...
                        <tbody>
                            {/* Render the list of pending rides */}
                            {pendingRides.map(ride => (
                                <tr key={ride.id}>
                                    ...
                                    <td>
                                        {/* Display the status of the ride */}
