...
const ViewCustomer = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:8085/rideHistory/${id}`)
      .then(response => {
  ...
  return (
    ...
    <div className='container py- mt-5 mb-'>
      <div className="d-flex justify-content-between mb3">
        <div><Link to="/customerRide" className="btn btn-outline-primary">Back</Link></div>
            ...
            <div className="col-md-10">
              <div className="bg-white shadow rounded p-4">
                ...
                {rides.length > 0 ? (
                  ...
                  <p className="text-center text-muted">No trips made from this customer </p>
                )}
              </div>
            </div>
          </div>
